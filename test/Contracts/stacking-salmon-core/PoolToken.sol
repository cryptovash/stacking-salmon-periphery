...
import "./StackingSalmonERC20.sol";
import "./interfaces/IERC20.sol";
import "./interfaces/IPoolToken.sol";
import "./libraries/SafeMath.sol";

contract PoolToken is IPoolToken, StackingSalmonERC20 {
    ...
    function _setFactory() external {
        require(factory == address(0), "Stacking Salmon: FACTORY_ALREADY_SET");
        factory = msg.sender;
    }
        ...
        returns (uint256 mintTokens)
    {
        ...
        require(mintTokens > 0, "Stacking Salmon: MINT_AMOUNT_ZERO");
        ...
        returns (uint256 redeemAmount)
    {
        ...
        require(redeemAmount > 0, "Stacking Salmon: REDEEM_AMOUNT_ZERO");
    ...
    function _safeTransfer(address to, uint256 amount) internal {
        ...
        require(
            ...
            "Stacking Salmon: TRANSFER_FAILED"
        );
    }
    ...
    modifier nonReentrant() {
        require(_notEntered, "Stacking Salmon: REENTERED");
        _notEntered = false;
        _;
        _notEntered = true;
    }
