...
contract Factory is IFactory {
    ...
    IStackingSalmonPriceOracle public stackingSalmonPriceOracle;
    ...
    constructor(
        ...
        IStackingSalmonPriceOracle _stackingSalmonPriceOracle
    ) public {
        admin = _admin;
        reservesAdmin = _reservesAdmin;
        bDeployer = _bDeployer;
        cDeployer = _cDeployer;
        stackingSalmonPriceOracle = _stackingSalmonPriceOracle;
    ...
    function initializeLendingPool(address uniswapV2Pair) external {
        ...
        (, , , , , bool oracleInitialized) = stackingSalmonPriceOracle.getPair(
            uniswapV2Pair
        );
