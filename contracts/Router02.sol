...
import "./interfaces/IStackingSalmonCallee.sol";
...
contract Router02 is IRouter02, IStackingSalmonCallee {
    ...
    modifier ensure(uint256 deadline) {
        require(deadline >= block.timestamp, "StackingSalmonRouter: EXPIRED");
        _;
    }
    ...
    function deleverage(
        ...
        require(redeemTokens > 0, "StackingSalmonRouter: REDEEM_ZERO");
    ...
    function _removeLiqAndRepay(
        ...
        .burn(address(this));
        require(amountAMax >= amountAMin, "StackingSalmonRouter: INSUFFICIENT_A_AMOUNT");
        require(amountBMax >= amountBMin, "StackingSalmonRouter: INSUFFICIENT_B_AMOUNT");
        // repay and refund
    ...
    function stackingSalmonBorrow(
        ...
        require(sender == address(this), "StackingSalmonRouter: SENDER_NOT_ROUTER");
        require(
    ...
    function _quote(
        ...
        require(amountA > 0, "StackingSalmonRouter: INSUFFICIENT_AMOUNT");
        require(
            reserveA > 0 && reserveB > 0,
            "StackingSalmonRouter: INSUFFICIENT_LIQUIDITY"
        );
    ...
    {
        require(index < 2, "StackingSalmonRouter: INDEX_TOO_HIGH");
        borrowable = address(
            uint256(
                keccak256(
                    abi.encodePacked(
